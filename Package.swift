...
let opentelemetry = (name: "opentelemetry-swift", url: "https://github.com/open-telemetry/opentelemetry-swift.git", version: Version("2.0.1"))
...
let platforms: [SupportedPlatform] = useOTelSwiftPackage ?
    [.iOS(.v17), .tvOS(.v13), .macOS(.v12), .watchOS(.v7)] :
    [.iOS(.v17), .tvOS(.v12), .macOS(.v12), .watchOS(.v7)]
